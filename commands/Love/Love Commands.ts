      ...
      subcommands: {
        ...
        ship: {
          ...
          execute: async ({ client, interaction }: ExecuteFunction) => {
            ...
            if (
              (shipTarget1.id !== "333644367539470337" &&
                shipTarget2.id !== "841854342255345664") ||
              (shipTarget2.id !== "333644367539470337" &&
                shipTarget1.id !== "841854342255345664")
            ) {
              shipEmbed.addFields({
              ...
              const riggedPercentage = Math.floor(Math.random() * 21) + 75;
              shipEmbed.addFields({
                name: "Matchmaking Result:",
                value: ` Their love-score is ${riggedPercentage}%! 💘`
              });
            }
