...
export class UserActivity {
    ...
    for (const activity of activities) {
      ...
      switch (activity.type) {
        ...
        case ActivityType.Listening:
          ...
          name = `${
            activity.name
              ? `Listening on ${activity.name} ${Emojis.Spotify}`
              : "Listening to Music 🎧"
          }`;
        ...
        case ActivityType.Playing: {
          let gameName: string = activity.name ?? ""; // Name of the game
          let gameDetails: string = activity.details ?? ""; // Details i.e. in Customs etc.
          let gameState: string = activity.state ?? ""; // State i.e. in a match, in the lobby etc.
   ...
   * @returns {EmbedField[]} Array of formatted embed fields
   */
  public getActivityFields(): EmbedField[] {
