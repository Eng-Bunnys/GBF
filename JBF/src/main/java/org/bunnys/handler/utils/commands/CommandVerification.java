...
import org.bunnys.handler.utils.ColorCodes;
import org.bunnys.handler.utils.Emojis;
 ...
 *
 * <p>This utility class provides a clean separation between validation logic and error presentation,
 * with comprehensive error handling and performance optimizations.</p>
 *
 * <p><strong>Responsibilities:</strong></p>
 * <ul>
 *   <li>Validates developer-only command restrictions</li>
 *   <li>Checks user and bot permissions</li>
 *   <li>Manages command cooldowns</li>
 *   <li>Provides structured validation results</li>
 * </ul>
 *
 * @since 1.0
 */
public final class CommandVerification {
     ...
     * @return A {@link ValidationResult} containing the outcome and any error details
     * @throws IllegalArgumentException if any parameter is null
     */
    public static ValidationResult validateExecution(JBF client, MessageReceivedEvent event, MessageCommandConfig config) {
    ...
    /**
     * Convenience method that validates execution and automatically sends error messages if validation fails.
     *
    ...
    public static class ValidationResult {
        ...
        public ValidationFailureType getFailureType() { return failureType; }
