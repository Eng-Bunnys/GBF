                       //Getting the user as a User from the interaction options
                        ...
                        if (fetchedMember && (mentionedUser.displayAvatarURL() !== fetchedMember.displayAvatarURL())) {
                            ...
                            avatarEmbed.setDescription(`[Avatar URL](${mentionedUser.displayAvatarURL({ format: "png", dynamic: true, size: 1024 })})\n[Server Avatar URL](${fetchedMember.displayAvatarURL({ format: "png", dynamic: true, size: 1024})})`)
