            ...
            subcommands: {
                ...
                bonk: {
                    ...
                    execute: async ({
                        ...
                        const weirdargs = new MessageEmbed()

                            .setTitle(title.ERROR, `Error: User is lonely <:PepeLaugh:755582130175868979>`)
                            .setDescription(`Please mention someone who's not you <:facepalm:705007575745298453>`)
                            .setColor(colors.ERRORRED)

                        const mainembed = new MessageEmbed()

                            .setTitle(`BONK <:BONK:864267943206715453>`)
                            .setDescription(`**<@${interaction.user.id}> bonks ${mentionedUser}**`)
                            .setImage(img)
                            .setColor(colors.DEFAULT)
                            .setFooter({
                    ...
                    execute: async ({
                        ...
                        if (mentionedUser.id === interaction.user.id) {
                            ...
                            const weirdargs = new MessageEmbed()
                                ...
                                .setDescription(`Mention someone that is not <@${interaction.user.id}> to bully!\n\`Mention someone that's not you lol\``)
                                .setColor(colors.ERRORRED)
                        ...
                        const mainembed = new MessageEmbed()
                            ...
                            .setTitle("WTH")
                            .setDescription(`**<@${interaction.user.id}> bullies ${mentionedUser}**`)
                            .setImage(img)
                            .setColor(colors.DEFAULT)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                ...
                cuddle: {
                    ...
                    execute: async ({
                        ...
                        const norealuser = new MessageEmbed()

                            .setTitle(title.ERROR, ` Error: User is lonely`)
                            .setDescription("Hey if you don't have anyone to cuddle you could always cuddle me! <:trollface:838959517965353060>")
                            .setColor(colors.ERRORRED)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                                iconURL: interaction.user.displayAvatarURL()
                        ...
                        const cuddleEmbed = new MessageEmbed()
                            ...
                            .setTitle("Cuddles!")
                            .setDescription(`**<@!${interaction.user.id}> is cuddling with ${mentionedUser}**`)
                            .setColor("#e91e63")
                            .setImage(link.url)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                ...
                hold: {
                    ...
                    execute: async ({
                        ...
                        if (mentionedUser.id === interaction.user.id) {
                            ...
                            const userisweird = new MessageEmbed()

                                .setTitle("Ummm...")
                                .setDescription(`**<@${interaction.user.id}> held hands with themselves??**`)
                                .setImage(img)
                                .setColor(colors.DEFAULT)
                                .setFooter({
                                    text: `Requested by: ${interaction.user.tag}`,
                        ...
                        const mainembed = new MessageEmbed()
                            ...
                            .setTitle("So cute!")
                            .setDescription(`**<@${interaction.user.id}> is holding hands with ${mentionedUser}**`)
                            .setImage(img)
                            .setColor(colors.DEFAULT)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                ...
                kiss: {
                    ...
                    execute: async ({
                        ...
                        const kissEmbed = new MessageEmbed()
                            ...
                            .setTitle("So cute!")
                            .setDescription(`**<@${interaction.user.id}> kissed ${mentionedUser}**`)
                            .setColor("#e91e63")
                            .setImage(link.url)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                ...
                hug: {
                    ...
                    execute: async ({
                        ...
                        const norealuser = new MessageEmbed()
                            ...
                            .setTitle(title.ERROR, ` Error: User can't find someone to hug <:PepeLaugh:755582130175868979>`)
                            .setDescription(`You could always hug me <:pleadingface:799827859505807380>`)
                            .setColor(colors.ERRORRED)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                                iconURL: interaction.user.displayAvatarURL()
                        ...
                        const hugEmbed = new MessageEmbed()
                            ...
                            .setTitle("So cute!")
                            .setDescription(`**<@!${interaction.user.id}> is hugging ${mentionedUser}**`)
                            .setColor("#e91e63")
                            .setImage(link.url)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                    ...
                    execute: async ({
                        ...
                        if (mentionedUser.id === interaction.user.id) {
                            ...
                            let errorembed2 = new MessageEmbed()
                                ...
                                .setTitle("Um okay")
                                .setDescription("You poked yourself! Now please mention another user")
                                .setColor("#FF0000")
                                .setFooter({
                                    text: `Requested by: ${interaction.user.tag}`,
                                    iconURL: interaction.user.displayAvatarURL()
                        ...
                        let pokeEmbed = new MessageEmbed()
                            ...
                            .setTitle("Poke!")
                            .setDescription(`**<@!${interaction.user.id}> is poking ${mentionedUser}**`)
                            .setColor("#e91e63")
                            .setImage(link.url)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                ...
                ship: {
                    ...
                    args: [{
                        ...
                        name: 'user-two',
                        type: 'USER',
                        description: 'Second user that you want to ship, user will be chosen if left empty',
                        required: false
                    }],
                    execute: async ({
                        client,
                        ...
                        const shipTarget2 = interaction.options.getUser("user-two") || interaction.user;

                        const shipEmbed = new MessageEmbed()
                            .setTitle("<a:flyinghearts:833542646579462164> | MatchMaking | <a:flyinghearts:833542646579462164>")
                            .setDescription(`
                            🔻 | ${shipTarget1} \n🔺 | ${shipTarget2}
                            `)
                            .setColor("#ff007f")
                        ...
                        if (shipTarget1.id === '333644367539470337' && shipTarget2.id === '580947967327076363') {
                            const shipEmbedRigged = new MessageEmbed()
                                ...
                                .setColor("#ff007f")
                                .addField('MatchMaking Result', (`
                                    Their love-score is ${Math.floor(Math.random() * 10)+85}%! 💘
                                  `))
                                .setFooter({
                                    text: `They call me cupid 💘`,
                                    iconURL: interaction.user.displayAvatarURL()
                            ...
                            return interaction.reply({
                                embeds: [shipEmbedRigged]
                            })
                        }

                        if (shipTarget2.id === '333644367539470337' && shipTarget1.id === '580947967327076363') {
                            const shipEmbedRigged = new MessageEmbed()
                                .setTitle("💗 | MatchMaking | 💗")
                                .setDescription(`
                                  🔻 | ${shipTarget1} \n🔺 | ${shipTarget2}
                                ...
                                .setColor("#ff007f")
                                .addField('MatchMaking Result', (`
                                    Their love-score is ${Math.floor(Math.random() * 10)+80}%! 💘
                                  `))
                                .setFooter({
                                    text: `They call me cupid 💘`,
                                    iconURL: interaction.user.displayAvatarURL()
                ...
                slap: {
                    ...
                    execute: async ({
                        ...
                        const slapEmbed = new MessageEmbed()
                            ...
                            .setTitle("Ouch!")
                            .setDescription(`**<@!${interaction.user.id}> slapped ${mentionedUser}**`)
                            .setColor("#e91e63")
                            .setImage(link.url)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                        ...
                        const slapEmbed2 = new MessageEmbed()
                            ...
                            .setTitle("Ouch!")
                            .setDescription(`**${mentionedUser} slapped <@!${interaction.user.id}> back!**`)
                            .setColor("#e91e63")
                            .setImage(link.url)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                        ...
                        const errorEmbed = new MessageEmbed()
                            ...
                            .setDescription("You slapped yourself congrats! Now please mention someone!")
                            .setColor("#FF0000")

                        const slapButton = new MessageButton()
                            .setCustomId('slap')
                            .setEmoji('🤚')
                            .setLabel(`Slap ${interaction.user.username} back`)
                            .setStyle('DANGER')

                        const slapButtonD = new MessageButton()
                            .setCustomId('slapD')
                            .setEmoji('🤚')
                            .setLabel(`Slap ${interaction.user.username} back`)
                            .setStyle('DANGER')
                        ...
                        const slapRow = new MessageActionRow().addComponents([slapButton])
                        const slapRowD = new MessageActionRow().addComponents([slapButtonD])
                ...
                tickle: {
                    ...
                    execute: async ({
                        ...
                        const tickleEmbed = new MessageEmbed()
                            ...
                            .setTitle("Tickle!")
                            .setDescription(`**<@!${interaction.user.id}> is tickling ${mentionedUser}**`)
                            .setColor("#e91e63")
                            .setImage(link.url)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
                        ...
                        const errorEmbed = new MessageEmbed()
                            .setTitle("I ran into an error! <:error:822091680605011978>")
                            .setDescription("You tickled yourself congrats! Now please mention someone")
                            .setColor("#FF0000")
                        ...
                        const tickleFight = new MessageButton()
                            .setCustomId('fight')
                            .setLabel('Tickle fight!')
                            .setStyle("SUCCESS")

                        const fightRow = new MessageActionRow().addComponents([tickleFight])

                        const tickleFightD = new MessageButton()
                            .setCustomId('fight')
                            .setLabel('Tickle fight!')
                            .setStyle("SUCCESS")
                            .setDisabled(true)

                        const fightRowD = new MessageActionRow().addComponents([tickleFightD])
                        ...
                        collector.on('collect', async i => {
                            ...
                            if (i.customId === 'fight') {
                                ...
                                const tickleEmbed2 = new MessageEmbed()

                                    .setTitle("Tickle!")
                                    .setDescription(`**${mentionedUser} tickled <@${interaction.user.id}> back, TICKLE FIGHT!**`)
                                    .setColor("#e91e63")
                                    .setImage(link.url)
                                    .setFooter({
                                        text: `Requested by: ${interaction.user.tag}`,
                ...
                kick: {
                    ...
                    execute: async ({
                        ...
                        if (mentionedUser.id === interaction.author.id) {

                            const NoMention = new MessageEmbed()
                                .setTitle("Um okay")
                                .setDescription("You kicked yourself! Now please mention another user")
                                .setColor("#FF0000")
                        ...
                        const mainembed = new MessageEmbed()
                            .setTitle("Ouch!")
                            .setDescription(`**<@${interaction.author.id}> kicks ${mentionedUser}**`)
                            .setImage(img)
                            .setColor(colors.DEFAULT)
                            .setFooter({
                                text: `Requested by: ${interaction.user.tag}`,
