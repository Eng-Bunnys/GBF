 ...
 * @description [For every 5 minutes spent, 10 XP is given, we use that information to calculate the number of hours]
...
/**
 * @param {*} time - [Time in minutes, each 5 minutes is 10 XP]
